  ...
  <div class="height-100">
    ...
    <form action="../../../proses/payment.php" method="post">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="payment/edit.php?id=<?php echo $row['id_pembayaran'] ?>" class="btn btn-warning" name="editPayment">
        ...
        <a href="payment/add.php" class="mt-1 btn btn-success" type="submit">Add Payment</a>
      </div>
    </form>
  </div>
</body>
