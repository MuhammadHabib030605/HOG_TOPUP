  ...
  <div class="height-100">
    ...
    <form action="../../../proses/product.php" method="post">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="product/edit.php?id=<?php echo $row['id_produk'] ?>" class="btn btn-warning" name="editProduct">
        ...
        <a href="product/add.php" class="mt-1 btn btn-success" type="submit">Add Service</a>
      </div>
    </form>
  </div>
</body>
