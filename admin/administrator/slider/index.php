  ...
  <div class="height-100">
    ...
    <form action="../../../proses/slider.php" method="post">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="slider/edit.php?id=<?php echo $row['id_slide'] ?>" class="btn btn-warning" name="editSlider">
        ...
        <a href="slider/add.php" class="mt-1 btn btn-success" type="submit">Add Slider</a>
      </div>
    </form>
  </div>
</body>
