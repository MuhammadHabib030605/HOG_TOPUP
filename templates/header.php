...
<head>
    ...
    <link rel="shortcut icon" href="http://<?= $_SERVER['SERVER_NAME'] ?>../image/logo/Logo.png"
        type="image/x-icon">
    <link rel="stylesheet" href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/css/style.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.2/font/bootstrap-icons.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <title>HOG - Top Up Game Mobile Legends Termurah Dan Tercepat</title>
    <style>
    * {
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link me-1" aria-current="page"
                                href="../index.php">
            ...
            if (isset($_SESSION['no_handphone'])) {
              ?>
                        <a href="../../account/index.php"
                            class="btn btn-secondary btn-circle d-flex justify-content-center align-items-center">
                            <?php
                $id = $_SESSION['id'];
              ...
              ?>
                        <li class="nav-item">
                            <a href="../account/auth/login.php"
                                class="btn btn-light">
                                Login
                            </a>
                            <a href="../account/auth/register.php"
