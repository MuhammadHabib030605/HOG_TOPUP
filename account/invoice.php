...
if ($result->num_rows > 0) {
  if ($row['id_user'] == $id_user) {
    if ($kategori == 'Topup') {
      ...
      $formattedDateTime = $dateTime->format('l, d F Y ');
...
<body>
    <div class="container mt-5 pt-5" id="topup" data-bs-theme="dark">
        <div class="col-lg-9 mx-auto">
            ...
            <h4 class="text-center">TERIMA KASIH SUDAH TOP UP DI HOUSE OF GAMERS </h4>
          </div>';
            ...
            <div class="card text-bg-dark mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4">
                            <p class="card-text">
                                <b><?= "Rp. " . number_format($row['harga_produk'], 0, ",", ".") ?>,-</b>
                            </p>
                        </div>
                    </div>
                    <div class="row mb-2">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <strong
                                class="card-text text-light fs-5"><?= "Rp. " . number_format($row['total'], 0, ",", ".") ?>,-</strong>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ol>
                                ...
                                <li>
                                    Buka menu atau tab transfer dalam aplikasi E-Wallet Anda. Biasanya tertulis
                                    "Transfer", "Kirim Uang",
                                    atau yang serupa, lalu masukkan nomor handphone "083893082654"
                                </li>
                                <li>
                                    Kemudian pilih nominal yang mau di transfer sesuai dengan harga dari layanan yang
                                    dibeli
                                </li>
                                <li>
                                    Lihat kembali detail transfer Anda untuk memastikan semuanya benar, termasuk nama
                                    penerima dan jumlah
                                    uang. Setelah yakin, pilih opsi untuk mengonfirmasi
                                </li>
                                <li>a Beberapa aplikasi mungkin meminta Anda untuk memasukkan kata sandi, PIN, atau
                                    melakukan verifikasi
                                    lainnya untuk menyelesaikan transfer
                                    </la>
                                <li>
                                    Setelah transfer berhasil, silahkan anda simpan bukti transfer untuk Anda kirim ke
                                    nomor Whatsapp
                                    "083893082654" agar segera dikonfirmasi oleh Admin dan segera di proses
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="card text-bg-dark mb-3">
                ...
                <div class="card-body">
                    ...
                    <a href="https://wa.me/083893082654" class="btn btn-secondary">Kontak Kami</a>
                </div>
            </div>
        </div>
    </div>
