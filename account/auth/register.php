...
<head>
    ...
    <link rel="shortcut icon" href="http://localhost/ZeeShop/image/logo/Logo.png" type="image/x-icon">
            ...
            <div class="row border rounded-5 p-3 bg-dark shadow box-area">
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                    <div class="featured-image mb-2">
                        <img src="../../image/logo/Logo.png" class="d-lg-block d-none" style="width: 300px;">
                    </div>
                </div>
