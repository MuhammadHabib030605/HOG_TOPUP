...
<head>
    ...
    <title>HOG - <?php echo $kategori ?></title>
    <style>
    .image-container {
        position: relative;
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card bg-dark shadow-lg">
                                <div class="card-body">
                                    <img src="data:../image/product/;base64,<?php echo base64_encode($gambar_produk) ?>"
                                        alt="<?php echo $nama_produk ?>"
                                        class="shadow rounded bg-dark mx-auto mt-3 mb-2 d-lg-block d-none"
                                        width="200" />
                                    <div class="row">
                        ...
                        <div class="col">
                            <div class="card bg-dark shadow-lg text-light">
                                <div class="card-header border-bottom border-secondary">
                                    <h4 class="card-title mt-2"><span class="badge bg-secondary">1</span> Masukkan User
                                        ID</h4>
                                </div>
                                <div class="card-body">
                                    <div id="userData">
                                        <div class="row row-cols row-cols-md">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Masukkan User ID"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Masukkan Server ID"
                                                        type="text" name="serverid" id="serverid" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="card text-light bg-dark shadow-lg">
                                        ...
                                        <div class="card-body">
                                            <select class="form-select form-select mb-3" name="nominal"
                                                onchange="getData()" aria-label="Large select example" id="waktuSelect">
                                        ...
                                        <div class="card-body">
                                            <div class="list-group">
                                                <div class="btn-group" role="group"
                                                    ...
                                                    <input type="radio" class="btn-check" name="pembayaran" value=""
                                                        id="btnradio1" autocomplete="off" required>
                            ...
                            if (isset($_SESSION['no_handphone'])) {
                              ?>
                                                <input class="form-control" placeholder="08xxxxxxxx" type="text"
                                                    name="handphone" value="<?= $_SESSION['no_handphone'] ?>" required>
                                                <?php
                            } else {
                              ?>
                                                <input class="form-control" placeholder="08xxxxxxxx" type="text"
                            ...
                            ?>
                                                <small class="text-warning mt-4">Pastikan data milik anda sudah terisi
                                                    dengan benar</small><br>
